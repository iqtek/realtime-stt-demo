...
def print_streaming_recognition_responses(responses, agi):
    for response in responses:
        for result in response.results:
#            if agi != None:
#                agi.verbose("Phrase start: %s" % str(result.recognition_result.start_time.ToTimedelta()))
#                agi.verbose("Phrase end: %s" % str(result.recognition_result.end_time.ToTimedelta()))
#                agi.verbose("Is Final: %s" % str(result.is_final))
#            else:
#                print("Phrase start: %s" % str(result.recognition_result.start_time.ToTimedelta()))
#                print("Phrase end: %s" % str(result.recognition_result.end_time.ToTimedelta()))
...
#        self.add_argument("audio_file", type=str, default=None, help="Audio file to recognize or 'pyaudio:' to use stream from mic.")
